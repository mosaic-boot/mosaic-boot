...
@Document(collection = "\${mosaic.datasource.mongodb.collections.payment-coupon.collection:payment.coupons}")
data class PaymentCouponEntity(
    @Id
    ...
    override val oncePerUser: Boolean,
    override val discounts: List<PaymentCouponDiscount>,
    override val data: Map<String, Any?>? = null
) : PaymentCoupon, UpdatableEntity<String>
