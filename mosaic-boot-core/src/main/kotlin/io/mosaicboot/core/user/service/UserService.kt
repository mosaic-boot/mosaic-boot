...
import io.mosaicboot.core.domain.user.*
...
class UserService(
    ...
    fun login(
        ...
        val authDetail = authenticationService.findAuthenticationDetail(method, username)
        ...
        if (!authenticationService.validateCredential(method, username, credential, authDetail)) {
            logFailedLogin(
    ...
    fun isRegistrable(method: String): Boolean {
        return authenticationService.isRegistrable(method)
    }
    ...
    fun register(
        ...
        try {
            ...
            val existingAuth = authenticationService.findAuthenticationDetail(method, username)
            ...
            val encodedCredential = authenticationService.encodeCredential(method, username, credential)
    ...
    private fun logRegister(
        ...
        auditService.addLog(UserAuditLogVo(
            userId = userId,
